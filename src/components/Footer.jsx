...
const Footer = () => {
  return (
    <div className="rounded-div mt-8 pt-8 text-primary">
          ...
          <div className="w-full flex justify-end">
            <div className="w-full md:w-[300px] py-4 relative">
              ...
              <div className="py-4">
                <form>
                  <input
                    className="bg-primary focus:outline-none border border-input p-2 mr-2 w-full shadow-xl rounded-2xl md:w-auto"
                    type="email"
      ...
      <p className="text-center py-4">Powered by Muhammad UFO</p>
    </div>
  );
};
